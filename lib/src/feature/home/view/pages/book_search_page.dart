...
class BookDetailPageSearch extends StatelessWidget {
  final HomeController controller;
  List<StorageModel?> listBook = [];
  List<SearchModels?> listBook1 = [];

  BookDetailPageSearch({super.key}) : controller = HomeController(AppRepositoryImpl());
                        ...
                        children: [
                          ...
                          PlayButtons(
                            ...
                            onTap: () async {
                              ...
                              context.go(
                                "${AppRouteName.mainPage}${AppRouteName.searchPage.substring(1)}/${AppRouteName.bookSearchPage}/${AppRouteName.pdfPage}",
